              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: isEarnings==true? Color(0xff82DAA9) : Color(0xffFFCCCC),
                  ),

                  child: Icon(
                    isEarnings==true ? Icons.arrow_drop_up : Icons.arrow_drop_down,
                  ),
                ),
                SizedBox(width: 8.w),
                Text(total??"", style: AppTextStyle.iBMP16w500),
              ],
            )
