import 'package:employee_portal_mobile_app/feature/mission/data/model/response_get_mission_model.dart';
...
import 'mission_remote_data_source.dart';

class MissionRemoteImplDio implements MissionRemoteDataSource {
  final ApiService apiService;

  MissionRemoteImplDio({required this.apiService});
  ...
  @override
  Future<List<
      ResponseGetReviewMissionRequestModel>> getReviewerMissionRequests() async {
    ...
    return [
      ...listReviewerNotReviewed,
      ...listReviewerReviewed,
    ];
  }

  @override
  Future<List<
      ResponseGetReviewMissionRequestModel>> getEmployeeMissionRequests() async {
    ...
    final listEmployeeReviewed = responseEmployeeReviewed.data.map<
        ResponseGetReviewMissionRequestModel>(
          (json) => ResponseGetReviewMissionRequestModel.fromJson(json),
    ).toList();
    return [
      ...listEmployeeNotReviewed,
      ...listEmployeeReviewed,
    ];
  }
}
