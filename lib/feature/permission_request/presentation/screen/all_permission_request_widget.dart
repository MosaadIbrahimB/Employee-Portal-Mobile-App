...
import '../widget/details_item_of_permission_request_widget/details_item_of_permission_request_widget.dart';
import '../widget/tab_credits_permission_request/tab_credits_permission_request_widget.dart';
...
class AllPerMissionRequestWidget extends StatelessWidget {
  ...
  static final List<Widget> listBody = [
    ...
    TabCreditsPerMissionRequestWidget(),
    DetailsItemOfPerMissionRequestWidget(),
