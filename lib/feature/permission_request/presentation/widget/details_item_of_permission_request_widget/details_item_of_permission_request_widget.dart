...
class DetailsItemOfPerMissionRequestWidget extends StatelessWidget {
  const DetailsItemOfPerMissionRequestWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TabSwitcherCubit, int>(
      builder: (context, state) {
        ...
        ResponsePermissionRequestModel model = context.read<TabSwitcherCubit>().getModel();
        return Column(
          ...
          children: [
            ...
            CustomTitleAndValueWidget(
              title: "نوع الاذن",
              value: model.permissionTypeName ?? "غير متاح",
            ),
            SizedBox(height: 16.h),
