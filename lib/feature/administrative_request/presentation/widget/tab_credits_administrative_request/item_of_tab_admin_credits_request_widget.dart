...
class ItemOfTabAdminCreditsRequestWidget extends StatelessWidget {
  const ItemOfTabAdminCreditsRequestWidget({super.key, required this.model});

  final ResponseAdministrativeModel model;
      ...
      switch (selected) {
        case 'approve':
          ...
          if (context.mounted) {
            ...
            context
                .read<GetReviewerAdministrativeRequestCubit>()
