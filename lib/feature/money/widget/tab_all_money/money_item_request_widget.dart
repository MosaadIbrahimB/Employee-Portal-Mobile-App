...
class MoneyItemRequestWidget extends StatelessWidget {
  const MoneyItemRequestWidget({super.key, required this.reportModel});
          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 8.h),
                Text(
                  reportModel.typeReport?? "استقالة",
            ...
            Row(
              children: [
                ...
                SizedBox(width: 8.h),
                Text("قيمة الطلب  : ${reportModel.amount??00} EGP", style: context.text.bodySmall),
              ],
            ),
            SizedBox(height: 8.h),
            Row(
