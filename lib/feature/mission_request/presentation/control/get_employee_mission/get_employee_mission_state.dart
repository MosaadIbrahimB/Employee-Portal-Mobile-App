...
class GetEmployeeMissionRequestState extends Equatable{
  ...
  const GetEmployeeMissionRequestState({this.selectedRequestType, this.isLoading= false, this.errorMessage, this.response});
  ...
  copyWith({
    ...
    return GetEmployeeMissionRequestState(
