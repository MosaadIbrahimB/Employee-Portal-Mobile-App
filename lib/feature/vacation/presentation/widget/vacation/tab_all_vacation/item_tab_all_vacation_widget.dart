...
class ItemTabAllVacationWidget extends StatelessWidget {
  final GetEmployeeVacationsModel employeeVacationsModel;
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    employeeVacationsModel.typeName ?? "",
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    TextWidget(
                      title:
                          "مسحوبات الرصيد | ${employeeVacationsModel.balanceWithdrawals}",
                    ),
                    SizedBox(width: 61.w),
                    ...
                    TextWidget(
                      title:
                          "الرصيد المتاح| ${employeeVacationsModel.availableBalance}",
                    ),
                  ],
                ),
              ),
                ...
                children: [
                  Expanded(
                    child: ItemOfFromToWidget(
                      title: "من",
                      date: employeeVacationsModel.fromDate ?? "22 نوفمبر 2024",
                    ),
                  ),
                  SizedBox(width: 8.w),
                  Expanded(
                    child: ItemOfFromToWidget(
                      title: "من",
                      date: employeeVacationsModel.toDate ?? "22 نوفمبر 2024",
                    ),
                  ),
                ],
              ),
